...
<div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col" style="margin: auto">
    <div class="tm-bg-primary-dark tm-block tm-block-products">
        ...
        <div class="tm-product-table-container">
            <table class="table table-hover tm-table-small tm-product-table">
                ...
                <c:forEach items="${customers}" var="customer">
                    <tr>
                        <th>
                            <a href="/admin-customer?action=customer-update&id=${customer.id}" style="color: #fff">
                                    ${customer.id}
                            </a>
                        </th>
                        <td>
                        ...
                        <td>
                            <a href="/admin-customer?action=customer-delete&id=${customer.id}"
        ...
        <%--ADD NEW BUTTON--%>
        <a href="/admin-customer?action=customer-create"
           class="btn btn-primary btn-block text-uppercase mb-3">Add new user
        </a>
    </div>
</div>
