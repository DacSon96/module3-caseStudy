...
INSERT INTO `cart` VALUES (1,1,1,19.99),(2,2,2,37.98),(3,3,1,37.99),(4,4,2,39.98),(5,5,1,17.99),(6,6,2,39.98),(7,7,1,38.99),(8,8,2,37.98),(9,9,1,18.99),(10,10,2,73.98),(11,11,1,19.99),(12,12,2,35.98);
...
INSERT INTO `category` VALUES (1,'Shirt'),(2,'Hoodie'),(3,'Jacket'),(4,'Cardigan'),(5,'Sweater');
...
INSERT INTO `customer` VALUES (1,'admin','','','admin','admin',0,''),(2,'Truc','0983156547','Hanoi','truc','truc',1,'truc@gmail.com'),(3,'Toan','0931567314','Haiphong','toan','toan',1,'toan@gmail.com'),(4,'Hanh','0934618638','Danang','hanh','hanh',1,'hanh@gmail.com'),(5,'Son','0943463148','Hochiminh','son','son',1,'son@gmail.com'),(6,'Tu','0913164645','Hanoi','tu','tu',1,'tu@gmail.com'),(7,'Hoan','0969618613','Hochiminh','hoan','hoan',1,'hoan@gmail.com');
...
CREATE TABLE `order` (
  ...
  KEY `cartId` (`cartId`),
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`customerId`) REFERENCES `customer` (`id`) ON DELETE SET NULL,
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`cartId`) REFERENCES `cart` (`id`) ON DELETE SET NULL
...
INSERT INTO `order` VALUES (1,2,1),(2,3,2),(3,4,3),(4,5,4),(5,6,5),(6,7,6),(7,3,7),(8,4,8),(9,5,9),(10,6,10),(11,7,11),(12,4,12),(13,5,12),(14,6,11),(15,7,10),(16,5,9),(17,6,8),(18,7,7),(19,6,6),(20,7,5),(21,7,4),(22,2,3),(23,3,2);
...
-- Dump completed on 2021-10-08 16:54:38
